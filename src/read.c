...
static struct variable *do_define (char *name, enum variable_origin origin,
                                   struct ebuffer *ebuf);
static int conditional_line (char *line, size_t len, const gmk_floc *flocp);
...
static int
conditional_line (char *line, size_t len, const gmk_floc *flocp)
{
  const char *cmdname;
